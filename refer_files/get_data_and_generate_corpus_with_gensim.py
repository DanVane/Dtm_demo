...
dat_outfile.write('id \t title \t abstract\n') #write header

tweets = list()
#Set total_tweets list per year, starting at 0
#total_tweets_list = [0 for year in pub_years]
...
for year in time_stamps: #For each year
    ...
    #Query
    query = "SELECT ID, TITLE, ABSTRACT FROM paper WHERE ABSTRACT is not null and PUB_YEAR = " + year + " "
